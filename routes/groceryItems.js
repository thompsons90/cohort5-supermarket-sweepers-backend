...
const {
  getGroceryItems,
  getMeatDataCollectionFromFirestore,
  getWalmartCollectionFromFirestore,
  getKrogerCollectionFromFirestore,
} = require('../controllers/groceryItems');

// router.route('/groceryitems').get(getGroceryItems);
router.route('/meat').get(getMeatDataCollectionFromFirestore);
